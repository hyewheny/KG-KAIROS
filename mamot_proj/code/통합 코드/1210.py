...
class Thread_mode():
                ...
                while( cap.isOpened() ): 
                    ...
                    if self.position_fg == 1:
                        ...
                        if self.frame_count % 11 == 0:
                            aruco_process(frame)
                    if cv2.waitKey(1) & 0xFF == ord('q') or self.position_fg == 0:
                        cap.release()
    ...
    def bridge_thread(self):
        def back_pose2():
            ...
            while rospy.Time.now() - start_time < rospy.Duration(13.0):  
                self.vel_pub.publish(msg)
                rate.sleep() 
        ...
        def agv_listener_callback(msg):
                if msg['data'] == '1':
                    ...
                    print("3. Moving next to charge position")
        ...
        while not self.exit_fg:    
            ...
            while self.status_fg == 3:
                ...
                audio_talker.publish(roslibpy.Message({'data':'44'}))
    ...
    def move_thread(self):
        ...
        def send_goal(pose_id):
            ...
            if pose_id == 1:
                ...
                goal.target_pose.pose.position.x = 0.94 
                ...
                # go to tire (1.48, -0.75)
                goal.target_pose.pose.position.x = 1.75
                goal.target_pose.pose.position.y = -0.85 
